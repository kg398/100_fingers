...
dof4_thumb_config =        [[0,2,2,2,2,0,0,0,0,0,0],//metacarpal
                            ...
                            [1,1,3,2,1,1,2,1,1,0,0],//intermediate
                            [1,3,0,0,0,0,1,1,1,0,0]];//distal
dof3_config =              [[0,2,2,2,2,0,0,0,0,0,1],                
                            [2,1,3,2,1,1,0,1,1,0,0],
                            [1,3,0,0,0,0,1,1,1,0,0]];
dof3_thumb_config =        [[0,2,2,2,2,0,0,0,0,0,0],                
                            [2,1,3,2,1,1,0,1,1,1,0],
                            [1,3,0,0,0,0,1,1,1,0,0]];
dof2_config =              [[0,1,2,2,0,0,0,0,0,0,1],                
                            [1,1,3,2,0,0,0,1,1,0,0],
                            [1,3,0,0,0,0,1,1,1,0,0]];
dof2_thumb_config =        [[0,1,2,2,0,0,0,0,0,0,0],                
                            [1,1,3,2,0,0,0,1,1,1,0],
                            [1,3,0,0,0,0,1,1,1,0,0]];

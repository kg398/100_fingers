    ...
    union(){
        ...
        rotate([0,0,0]){
            ...
            translate(o_thumb) rotate([0,0,-print_ang]) rotate(a_thumb)
                thumb(bl_thumb,jd_thumb,ang=print_ang,lig=lig_index,pulley=p_thumb,bone_width=w_thumb); 
            //palm
...
module hand_nolig(){
    union(){
        ...
        rotate([0,0,0]){
            ...
            //thumb
            translate(o_thumb) rotate([0,0,-print_ang]) rotate(a_thumb)
                thumb_nolig(bl_thumb,jd_thumb,ang=print_ang,lig=lig_index,pulley=p_thumb,bone_width=w_thumb); 
            //palm
            translate([0,max(o_index[1],o_middle[1],o_ring[1],o_little[1],o_thumb[1]),(o_thumb[2]+o_little[2])/2]) rotate([-90,0,0])
                palm(min(jd_index[0],o_middle[1]+jd_middle[0],o_ring[1]+jd_ring[0],o_little[1]+jd_little[0],o_thumb[1]+jd_thumb[0])-max(o_index[1],o_middle[1],o_ring[1],o_little[1],o_thumb[1]),30,o_thumb[2]-o_little[2]+5);
        }
    ...
    union(){
        ...
        rotate([0,0,0]){
            ...
            translate([0,max(o_index[1],o_middle[1],o_ring[1],o_little[1],o_thumb[1]),o_middle[2]]) rotate([-90,0,0])
                palm(min(jd_index[0],o_middle[1]+jd_middle[0],o_ring[1]+jd_ring[0],o_little[1]+jd_little[0],o_thumb[1]+jd_thumb[0])-max(o_index[1],o_middle[1],o_ring[1],o_little[1],o_thumb[1]),30,2*o_thumb[2]-2*o_middle[2]+5);
        }
    }
}
